# [CSCC69 Operating Systems](https://thierrysans.github.io/CSCC69/)

This is the source code for the CSCC69 course website.
...
```shell
$ git remote add upstream git@github.com:ThierrySans/CSCC69.git
